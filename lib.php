...
function buckle_process_css($css, $theme) {
    ...
    $css = buckle_set_menubackcolor($css, $menubackcolor);
    ...
    $css = buckle_set_menuhovercolor($css, $menuhovercolor);
    ...
    $css = buckle_set_backimage($css, $backimage);
    ...
    $css = buckle_set_backposition($css,$backposition);
    ...
    $css = buckle_set_backcolor($css, $backcolor);
...
function buckle_set_menubackcolor($css, $menubackcolor) {
...
function buckle_set_menuhovercolor($css, $menuhovercolor) {
...
function buckle_set_backimage($css, $backimage) {
	global $OUTPUT;  
...
function buckle_set_backposition($css, $backposition = 'no-repeat', $tag = '[[setting:backposition]]'){
...
function buckle_set_backcolor($css, $backcolor) {
